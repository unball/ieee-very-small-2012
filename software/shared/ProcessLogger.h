 ...
 * @contributor		William Batista Aguiar Motta
 * @date			06/14/2010
 *
...
public:
	...
	static LogLevel & getPrintLevel ()
	{
		return printLevel_;
	}
	static void setPrintLevel (const LogLevel & printLevel)
	{
...
private:
	...
	static inline const char * msgColor (LogLevel level)
	{
		...
		case LEVEL_FATAL:
		{
			return "\033[31m\033[1m";    //red
		}
		case LEVEL_ERROR:
		{
			return "\033[33m\033[1m";    //orange
		}
		case LEVEL_WARN:
		{
			return "\033[32m\033[1m";    //green
		}
		case LEVEL_INFO:
		{
			return "\033[0;0m\033[1m";    //standard
		}
		case LEVEL_DEBUG:
		{
			return "\033[36m\033[1m";    //cyan
		}
		case LEVEL_VERBOSE:
		{
			return "\033[34m\033[1m";    //blue
		}
		default:
		{
			return "\033[35m\033[1m";    //white
		}
		}
	}
